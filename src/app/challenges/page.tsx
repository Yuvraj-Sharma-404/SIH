...
const DEMO_CHALLENGES: ChallengeItem[] = [
  {
    id: "ch-1",
    title: "SOLID WASTE MANAGEMENT & AI SEGREGATION",
    category: "Sanitation",
    department: "Municipal Solid Waste Division",
    description:
      "Find innovative IoT and computer vision ways to improve waste segregation and illegal dumping detection in dense urban residential sectors.",
    requiredExpertise: "Computer Vision, Edge AI, IoT Bin Sensors, Urban Logistics",
  ...
  {
    id: "ch-2",
    title: "IOT-BASED STRUCTURAL HEALTH MONITORING FOR SCOUR-VULNERABLE BRIDGES",
    category: "Infrastructure",
    department: "Public Works Department (PWD)",
    description:
      "Develop an affordable, solar-powered IoT vibration and ultrasonic scour monitoring mesh network to detect bridge micro-cracks before catastrophic monsoon failure.",
    requiredExpertise: "Civil Engineering, Tri-Axial Accelerometers, LoRaWAN, Cloud Telemetry",
  ...
  {
    id: "ch-3",
    title: "LOW-COST SOLAR DRINKING WATER PURIFICATION & REAL-TIME QUALITY SENSING",
    category: "Water Supply",
    department: "Jal Jeevan Mission / Water Board",
    description:
      "Deploy decentralized solar UV-C filtration nodes with optical turbidity and pH telemetry for rural primary school drinking water borewells.",
    requiredExpertise: "Chemical Filtration, Water Quality Sensing, Solar Power Engineering",
    budgetEstimate: "₹2,00,000",
    status: "Open",
